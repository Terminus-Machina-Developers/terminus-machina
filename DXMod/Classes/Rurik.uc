...
//
//-----------------------------------------------------------
class Rurik extends ModHumanMilitary;

#exec OBJ LOAD FILE=DXModCharacters
#exec texture IMPORT NAME=RurikTex1 FILE=Textures\RurikTex1.pcx GROUP=Skins
#exec texture IMPORT NAME=RurikTex0 FILE=Textures\RurikTex0.pcx GROUP=Skins
//
...
defaultproperties
{
     ...
     DrawScale=1.100000
     MultiSkins(0)=Texture'DXModCharacters.Skins.RurikTex01'
     MultiSkins(1)=Texture'DeusExCharacters.Skins.PantsTex9'
     MultiSkins(2)=Texture'DXModCharacters.Skins.RurikTex00'
     MultiSkins(3)=Texture'DXModCharacters.Skins.RurikTex00'
